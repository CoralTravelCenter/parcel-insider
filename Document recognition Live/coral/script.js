...
if ( !wasShown && (locationPathname == '/' || locationPathname == '/coral.html' )){
    ...
    <div class="dm-ins-document_recognition-popup__inner">
        ...
        <div class="dm-ins-document_recognition-popup__text">
            ...
            <p><button style="display: inline-flex; justify-content:center; align-items:center; font-weight:bold; line-height: 1; height: 2.6em; padding: 0 1.5em; border: 0; outline: none; border-radius: .3em; color: white; background-color: #F0AB00; cursor:pointer;" data-action="dismiss">Все понятно!</button></p>
        </div>
        </div>
    </div>
    </div>
