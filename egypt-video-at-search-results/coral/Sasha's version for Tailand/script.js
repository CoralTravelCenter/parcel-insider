...
// var showVideoShown = sessionStorage.dminsvideo;
var showVideoShown = readCookie('dminsvideo');
var isThailand = $('.packageSearch__destinationInput[countryid="33"]');
        ...
        function showVideo() {
            ...
            <div class="dm-ins-video-thailand">
                <div class="dm-ins-video-thailand__content">
                    <div class="dm-ins-video-thailand__player" id="dm-ins-video__player--js" data-vimeo-idd="783234531"></div>
                    <div class="dm-ins-video-thailand__desc">
                        <div class="dm-ins-video-thailand__header">Отдохните от суеты на пляжах Пхукета!</div>
                        <div class="dm-ins-video-thailand__text">Море&nbsp;+30°C.&nbsp;Песок,&nbsp;как&nbsp;пудра*. Обзорная&nbsp;экскурсия&nbsp;—&nbsp;в&nbsp;подарок!</div>
                        <div class="dm-ins-video-thailand__note">*Покрытие и особенности песка зависят от пляжа</div>
                        <div class="dm-ins-video-thailand__btn-row"><a class="dm-ins-video-thailand__btn" href="https://www.coral.ru/amazing-tayland/" target="_blank" onclick="ym(553380,'reachGoal','popuptai_c')">Узнать больше</a></div>
                    </div>
                </div>
            </div>
            `;
