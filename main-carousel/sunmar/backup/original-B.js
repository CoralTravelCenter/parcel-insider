...
Insider.fns.onElementLoaded('[data-module="mainslider"]', function () {
    Insider.eventManager.once('click.ins:goal-' + variationId, '.carousel-item',
        function () {
            Insider.__external.sendCustomGoal(211, 39, true);
        });
}).listen();
/* ZEN-59011 End */