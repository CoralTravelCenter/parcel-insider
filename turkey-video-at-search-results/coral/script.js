...
var showVideoShown = readCookie('turkey_video_shown');
var isThailand = $('.packageSearch__destinationInput[countryid="1"]');
        ...
        function showVideo() {
            ...
            <div class="dm-ins-video-thailand">
                <div class="dm-ins-video-thailand__content">
                    <div class="dm-ins-video-thailand__player" id="dm-ins-video__player--js" data-vimeo-idd="795148933"></div>
                    <div class="dm-ins-video-thailand__desc">
                        <div class="dm-ins-video-thailand__header">Дополнительная скидка 4 999 ₽</div>
                        <div class="dm-ins-video-thailand__text">По промокоду <strong>4999</strong> до 4 февраля</div>
<!--                        <div class="dm-ins-video-thailand__note">*Покрытие и особенности песка зависят от пляжа</div>-->
                        <div class="dm-ins-video-thailand__btn-row"><a class="dm-ins-video-thailand__btn" href="https://www.coral.ru/hot-offers/rannee-bronirovanie-leto/?video" target="_blank" onclick="ym(553380,'reachGoal','popup_video_turkey')">Продолжить</a></div>
                    </div>
                </div>
            </div>
            `;
            ...
            myo.open({
                ...
                beforeOpen: function () {
                    ...
                    createCookie('turkey_video_shown', 1, 1)
                },
                afterClose: function () {
                    this.bodyDiv.html('');
                    isPopup = false;
